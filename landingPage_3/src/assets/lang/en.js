const en = {
  use: {
    top: {
      str1: "You (“User” or “You”) should read the full text of this End User License Agreement (“Agreement”) before using 577.com products. Once the agreement is concluded, it means that you recognize the brand owned and controlled by 577.com.",
      str2: "Please note that this agreement constitutes a legally binding agreement between you and 577.com.",
    ...
    content: {
      ...
      detail: {
        "str1-1":
          "Subject to the terms and conditions contained in the agreement, 577.com grants users non-exclusive, personal, non-transferable rights, allowing users to install and use software on the device (as appropriate) to access 577.com servers and play Real money games (hereinafter referred to as “games”) (software and games are collectively referred to as “services”).",
        "str1-2":
          "577.com allows you to use the software personally. Please note that the following people cannot use the service: (i) under 18 years of age; (ii) under the legal adult age of the jurisdiction in which they are located; and (iii) persons related to the site prohibited from use in the jurisdiction. 577.com cannot verify the legality of the service in various jurisdictions, and users are responsible for confirming whether the use of the service is legal.",
        "str1-3":
        ...
        "str1-4":
          "577.com has all rights to the software and its code, structure, and organization, including copyright, trade secrets, intellectual property rights, and other rights. Subject to the restrictions imposed by applicable laws, you must not:",
        "str1-4-a":
        ...
        "str2-1":
          "The service is provided “as is” and 577.com does not provide any, all express or implied guarantees. We have not made any guarantees or statements to you regarding the quality of service, any application, completeness and accuracy.",
        "str2-2":
        ...
        "str2-3":
          "577.com has the right to suspend, stop, immediately, at its absolute discretion, when it deems it necessary (for example, but not limited to: we have learned that you have entered into a voluntary gambling ban agreement with any gaming provider, or to manage, maintain, or update the software). Changes, cancellations or expansion of services without notice. 577.com is not responsible for any losses caused by this decision.",
        "str3-1":
          "577.com has the right to open, maintain and close site user accounts. Any decision of the 577.com management team regarding user accounts, service usage, and dispute resolution is the final decision, and users cannot apply for review or appeal. The account created by the user is hereinafter referred to as the 577.com account. The 577.com account allows you to access all sites that 577.com provides in accordance with the terms of this agreement (depending on your geographic location). All references to “user account” or “account” in this agreement refer to your 577.com account.",
        "str4-top-1":
          "You continue to state, guarantee, promise and agree before and after using the service:",
        "str4-1":
          "There is a risk of losing money when using the service, and 577.com is not responsible for compensating such losses;",
        "str4-2":
          "Your use of the service is entirely based on your choice and judgment, at your own risk;",
        "str4-3":
          "To help us comply with regulatory requirements and allow you to access and use software and / or services through our website, you will need to provide certain personal details (including details about payment methods) and agree to us (or our Third-party representatives) to access and use your location data and / or other such data and information originating from your device / computer so that you can use the service / software. You hereby consent to us (or our third-party representatives) to access and use such data for the above purposes. If you do not wish to be bound by this provision, you must not use our software and / or services. 577.com will process your personal details in accordance with the Philippine data protection laws and regulations in accordance with the privacy policy;",
        "str4-4":
        ...
        "str5-2":
          "personal use. The service is intended for users’ personal use only. Users can only bet for personal entertainment. Users must never use their “real currency account” in 577.com for purposes other than using the service. When users provide information to 577.com, they must provide complete and true information, and have an obligation to update the detailed information when it changes.",
        "str5-3":
          "Collude. It is strictly forbidden for users to collude with fraud by sharing hole cards or other methods. Among other measures, 577.com has the right to restrict seats and / or prohibit users from participating in a table or mini-game, including prohibiting two or more users from joining a table or mini-game at the same time. In addition, 577.com has the right to treat fraudulent or attempted collusion between players (including users) as a major breach of contract, and then has the right to close the accounts of users who engage in or attempt to engage in such activities (with or without success).",
        "str5-4":
          "Foreign aid program (EPA). 577.com prohibits foreign aid programs designed to give players an “unfair advantage” (hereinafter referred to as the “EPA Program”). “Outside” refers to computer software other than this software, and non-software-based databases or archives (such as websites or subscription services). “Unfair advantage” refers to users accessing or compiling information about other players that they cannot see during the game.",
        "str5-5":
        ...
        "str5-6":
          "You agree that 577.com can take measures to detect and prevent users from using prohibited EPA programs. These measures include but are not limited to checking the software programs running on the user’s computer and the 577.com software at the same time. You agree not to attempt to bypass, intervene, or prevent these measures, including but not limited to the use of third-party software that can bypass, intervene, or prevent these measures.",
        "str5-7":
          "Chip concessions. Chip dumping means that the user intentionally loses the hand in order to transfer the chips to other players. Anyone who participates in or attempts to participate in chip transfers while using the service, including the party receiving the funds, will be permanently prohibited from using the service and may immediately close the user’s account. At this time, 577.com is not obligated to return any funds in your user account.",
        "str5-8":
          "Fraud. For example, 577.com believes that users use the service to engage in or attempt to engage in fraud, illegality, dishonesty, Improper activities, including but not limited to engaging in any of the activities specified in Article 5 or any other manipulation Card game activities, or fraudulent payments (including but not limited to the use of stolen credit cards, fraudulent Refusal, money laundering), 577.com has the right to take measures that he deems appropriate, including but not limited to:",
        "str5-8-a": "A. Immediately block user access to the service;",
        "str5-8-b": "B. Close the user’s account in 577.com;",
        ...
        "str5-10":
          "Residents (including temporary visitors) of certain jurisdictions (including jurisdictions where players must abide by relevant laws and regulations and must use specific versions of game software) are prohibited from depositing into accounts or joining real currency games (hereinafter referred to as “disabled jurisdictions” “). For the avoidance of doubt, the aforementioned restrictive regulations prohibiting real money games in prohibited jurisdictions also apply to residents or citizens of other countries within the prohibited jurisdictions. Attempts to circumvent the aforementioned restrictions in prohibited jurisdictions are violations of the agreement. Attempts to circumvent include, but are not limited to, tampering with the information used by 577.com to confirm the position of the player, and providing the 577.com with erroneous and misleading information about the location and place of residence. If you try this behavior, we will take action, including but not limited to confiscating the funds in the user’s account.",
        "str5-11":
          "Agents, community leaders and guild leaders must abide by the terms of service of the 577.com platform. Any attempt to promote other competitive products of the same kind or transfer 577.com players will result in the account being closed and the funds confiscated. Any agent, community or guild leader who participates in the activities prohibited by the platform, robots, AI, over-money, money laundering, fraud and other platforms will permanently lose their agent qualifications, and their account funds and agent income will also be confiscated. Any agent, community leader and guild leader assisting or soliciting players from the prohibited area to the platform, operating in a manner that violates the terms of service will result in the account being closed and the funds and agency income confiscated.",
        "str6-1":
          "Policies and standards for users withdrawing funds from user accounts. 577.com has the right to determine the additional eligibility criteria that users need to meet to take a specific withdrawal method at a specific time.",
        "str7-1":
          "Users should not post any illegal, indecent, racist, obscene, defamatory, defamatory or threatening materials through the service when using chat functions, player avatar options or communicating with 577.com staff, or any violation of the law that is generally considered bad Informational material.",
        "str8-1":
          "“Without prejudice to other rights, if the user completely or partially violates the provisions of the agreement, 577.com has the right to take the measures it deems appropriate, including terminating this agreement or other agreements with the user, immediately stopping the user’s use of the service, and closing The user’s account on the site or other group sites confiscates all funds in the user’s account, and / or initiates legal proceedings against the user. “",
        "str8-2":
          "For all claims, requirements, liabilities, damages, losses, expenses and expenses, including legal fees and any other expenses, caused by the following reasons, you agree to provide full compensation to 577.com, the group and its shareholders, directors, and employees To defend against damage:",
        ...
        "str9-1":
          "Under any circumstances (including negligence), 577.com is not required to cause any special, incidental, direct, indirect or secondary damage (including but not limited to business profit loss, business interruption, business information loss due to the use (or improper use) of services Or other economic losses), even if the 577.com knows in advance the possibility of such damage.",
  ...
  about: {
    ...
    str12:
      "In addition, “win-win” is also one of the 577.com’s ideas. Cooperation with many world-famous championship brands, Including Asian Poker Tour (APT), World Poker Tour (WPT), Boya Poker Tour (BPT), etc.,Successfully held more than 40 events across Asia, and reached an in-depth cooperation with TritonPoker, the world’s top offline Hawker event brand in 2020, Become the exclusive sponsor of its new season and start a new journey.",
    str13: "577.com Get",
    str14: "Full authorization from CEZA and First Cagayan",
    str15:
      "577.com adheres to the core values of fairness and transparency, and takes customer first as a service concept to ensure that account processing for customers is completely safe, cautious and honest.",
    str16:
      "577.com offers highly trained and welcoming customer service, 24/7 live chat support in order to serve our customers whenever in need. We handle the issues for the players in the quickest, most polite and effective way.",
    imgs: {
      src1: "./static/img/about/en/biaoti.png",
      src2: "./static/img/header/logo.png"
    },
    str17: "1.2 Million",
  },
  support: {
  ...
  footer: {
    ...
    str5: "About Us",
    str6: "Terms of use",
    str7: "Copyright © 2023 577.com All rights reserved",
  },
